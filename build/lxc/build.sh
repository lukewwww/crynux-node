...
echo "[Build] Installing Node.js 18 and setting up Yarn via corepack..."
...
echo "[Build] Installing Go 1.21.0 for cgo build..."
curl -s -O -L "https://golang.org/dl/go1.21.0.linux-amd64.tar.gz"
tar -C /usr/local -xzf go1.21.0.linux-amd64.tar.gz
rm go1.21.0.linux-amd64.tar.gz

echo "[Build] Installing CUDA Toolkit 12.3.1..."
...
echo "[Build] Setting up main application venv in /app..."
...
echo "[Build] Setting up worker venv in /app..."
mkdir -p /app/worker
...
echo "[Build] Copying final artifacts to /app..."
...
echo "[Build] Installing and enabling systemd service..."
